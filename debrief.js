(function () {
  ...
  const fallbackQuotes = {
    indices: [
      { symbol: "^GSPC", name: "S&P 500", value: 7723.55, change: -0.17, spark: [] },
      { symbol: "^IXIC", name: "Nasdaq", value: 26363.44, change: -0.83, spark: [] },
      { symbol: "^DJI", name: "Dow", value: 54349.12, change: 0.49, spark: [] },
      { symbol: "^RUT", name: "Russell 2000", value: 3019.188, change: -0.59, spark: [] },
      { symbol: "^VIX", name: "VIX", value: 16, change: 1.2, spark: [] },
    ],
    currencies: [
      { symbol: "DX-Y.NYB", name: "U.S. Dollar", value: 99.8, change: 0.12, spark: [] },
      { symbol: "EURUSD=X", name: "EUR / USD", value: 1.1542, change: -0.11, spark: [] },
      { symbol: "GBPUSD=X", name: "GBP / USD", value: 1.3468, change: 0, spark: [] },
      { symbol: "JPY=X", name: "USD / JPY", value: 157.892, change: 0.14, spark: [] },
      { symbol: "AUDUSD=X", name: "AUD / USD", value: 0.7038, change: -0.27, spark: [] },
    ],
    commodities: [
      { symbol: "CL=F", name: "WTI Crude", value: 76.4, change: 1.57, spark: [] },
      { symbol: "BZ=F", name: "Brent Crude", value: 80.96, change: 1.9, spark: [] },
      { symbol: "NG=F", name: "Natural Gas", value: 2.662, change: -0.97, spark: [] },
      { symbol: "ZC=F", name: "Corn", value: 460, change: 0, spark: [] },
      { symbol: "ZW=F", name: "Wheat", value: 644, change: 0.27, spark: [] },
    ],
    metals: [
      { symbol: "GC=F", name: "Gold", value: 4295.4, change: -0.23, spark: [] },
      { symbol: "SI=F", name: "Silver", value: 61.37, change: -1.47, spark: [] },
      { symbol: "HG=F", name: "Copper", value: 6.74, change: 0.19, spark: [] },
      { symbol: "PL=F", name: "Platinum", value: 1741.5, change: -0.31, spark: [] },
      { symbol: "PA=F", name: "Palladium", value: 1373, change: 0.21, spark: [] },
    ],
    other: [
      { symbol: "^TNX", name: "U.S. 10Y", value: 4.647, change: 0.65, spark: [] },
      { symbol: "TLT", name: "Long Treasuries", value: 83, change: 0.22, spark: [] },
      { symbol: "HYG", name: "High Yield", value: 79.52, change: -0.04, spark: [] },
      { symbol: "SOXX", name: "Semiconductors", value: 530.7, change: -2.12, spark: [] },
      { symbol: "KRE", name: "Regional Banks", value: 77.34, change: -0.64, spark: [] },
      { symbol: "BTC", name: "Bitcoin", value: 64149, change: 0.09, spark: [] },
      { symbol: "ETH", name: "Ethereum", value: 1894.27, change: 1.36, spark: [] },
      { symbol: "SOL", name: "Solana", value: 72.84, change: -1.27, spark: [] },
    ],
  };
