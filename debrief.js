(function () {
  ...
  const fallbackQuotes = {
    indices: [
      { symbol: "^GSPC", name: "S&P 500", value: 7757.64, change: 0.62, spark: [] },
      { symbol: "^IXIC", name: "Nasdaq", value: 26690.615, change: 1.3, spark: [] },
      { symbol: "^DJI", name: "Dow", value: 54036.93, change: 0.28, spark: [] },
      { symbol: "^RUT", name: "Russell 2000", value: 3034.494, change: 1.1, spark: [] },
      { symbol: "^VIX", name: "VIX", value: 14.9, change: -1.65, spark: [] },
    ],
    currencies: [
      { symbol: "DX-Y.NYB", name: "U.S. Dollar", value: 99.604, change: 0.07, spark: [] },
      { symbol: "EURUSD=X", name: "EUR / USD", value: 1.1562, change: 0.32, spark: [] },
      { symbol: "GBPUSD=X", name: "GBP / USD", value: 1.3493, change: 0.34, spark: [] },
      { symbol: "JPY=X", name: "USD / JPY", value: 157.745, change: -0.44, spark: [] },
      { symbol: "AUDUSD=X", name: "AUD / USD", value: 0.7071, change: 0.57, spark: [] },
    ],
    commodities: [
      { symbol: "CL=F", name: "WTI Crude", value: 78.18, change: 1.15, spark: [] },
      { symbol: "BZ=F", name: "Brent Crude", value: 83.55, change: 1.29, spark: [] },
      { symbol: "NG=F", name: "Natural Gas", value: 2.662, change: 0.83, spark: [] },
      { symbol: "ZC=F", name: "Corn", value: 461.5, change: -0.11, spark: [] },
      { symbol: "ZW=F", name: "Wheat", value: 639.75, change: 1.35, spark: [] },
    ],
    metals: [
      { symbol: "GC=F", name: "Gold", value: 4399.7, change: 2.33, spark: [] },
      { symbol: "SI=F", name: "Silver", value: 63.499, change: 3.07, spark: [] },
      { symbol: "HG=F", name: "Copper", value: 6.591, change: -1.76, spark: [] },
      { symbol: "PL=F", name: "Platinum", value: 1759.6, change: 1.25, spark: [] },
      { symbol: "PA=F", name: "Palladium", value: 1378.3, change: 0.07, spark: [] },
    ],
    other: [
      { symbol: "^TNX", name: "U.S. 10Y", value: 4.66, change: -0.21, spark: [] },
      { symbol: "TLT", name: "Long Treasuries", value: 82.76, change: 0.29, spark: [] },
