(function () {
  ...
  const fallbackQuotes = {
    indices: [
      { symbol: "^GSPC", name: "S&P 500", value: 7316.15, change: -1.52, spark: [] },
      { symbol: "^IXIC", name: "Nasdaq", value: 24442.941, change: -1.74, spark: [] },
      { symbol: "^DJI", name: "Dow", value: 51594.14, change: -2.19, spark: [] },
      { symbol: "^RUT", name: "Russell 2000", value: 2906.31, change: -1.61, spark: [] },
      { symbol: "^VIX", name: "VIX", value: 19.11, change: -7.5, spark: [] },
    ],
    currencies: [
      { symbol: "DX-Y.NYB", name: "U.S. Dollar", value: 100.721, change: -0.16, spark: [] },
      { symbol: "EURUSD=X", name: "EUR / USD", value: 1.1474, change: 0.08, spark: [] },
      { symbol: "GBPUSD=X", name: "GBP / USD", value: 1.3371, change: 0.04, spark: [] },
      { symbol: "JPY=X", name: "USD / JPY", value: 162.94, change: -0.27, spark: [] },
      { symbol: "AUDUSD=X", name: "AUD / USD", value: 0.6977, change: 0.33, spark: [] },
    ],
    commodities: [
      { symbol: "CL=F", name: "WTI Crude", value: 84.21, change: -0.3, spark: [] },
      { symbol: "BZ=F", name: "Brent Crude", value: 90.46, change: 0.73, spark: [] },
      { symbol: "NG=F", name: "Natural Gas", value: 2.685, change: -1.36, spark: [] },
      { symbol: "ZC=F", name: "Corn", value: 473.5, change: 0.37, spark: [] },
      { symbol: "ZW=F", name: "Wheat", value: 678.5, change: 2.69, spark: [] },
    ],
    metals: [
      { symbol: "GC=F", name: "Gold", value: 4127.3, change: 0.74, spark: [] },
      { symbol: "SI=F", name: "Silver", value: 58.2, change: 0.19, spark: [] },
      { symbol: "HG=F", name: "Copper", value: 6.453, change: 2.24, spark: [] },
      { symbol: "PL=F", name: "Platinum", value: 1624.3, change: 1.37, spark: [] },
      { symbol: "PA=F", name: "Palladium", value: 1283, change: 2.46, spark: [] },
    ],
    other: [
      { symbol: "^TNX", name: "U.S. 10Y", value: 4.683, change: 1.32, spark: [] },
      { symbol: "TLT", name: "Long Treasuries", value: 82.85, change: -1.65, spark: [] },
      { symbol: "HYG", name: "High Yield", value: 79.24, change: -0.23, spark: [] },
      { symbol: "SOXX", name: "Semiconductors", value: 465, change: -5.38, spark: [] },
      { symbol: "KRE", name: "Regional Banks", value: 76.18, change: -0.79, spark: [] },
      { symbol: "BTC", name: "Bitcoin", value: 64844, change: 0.98, spark: [] },
      { symbol: "ETH", name: "Ethereum", value: 1923.32, change: 1.03, spark: [] },
      { symbol: "SOL", name: "Solana", value: 74.32, change: 1.17, spark: [] },
    ],
  };
