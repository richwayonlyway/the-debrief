(function () {
  ...
  const fallbackQuotes = {
    indices: [
      { symbol: "^GSPC", name: "S&P 500", value: 7437.63, change: 1.66, spark: [] },
      { symbol: "^IXIC", name: "Nasdaq", value: 25122.178, change: 2.78, spark: [] },
      { symbol: "^DJI", name: "Dow", value: 52208.06, change: 1.19, spark: [] },
      { symbol: "^RUT", name: "Russell 2000", value: 2946.101, change: 1.37, spark: [] },
      { symbol: "^VIX", name: "VIX", value: 17.24, change: 0.88, spark: [] },
    ],
    currencies: [
      { symbol: "DX-Y.NYB", name: "U.S. Dollar", value: 100.354, change: 0.49, spark: [] },
      { symbol: "EURUSD=X", name: "EUR / USD", value: 1.1493, change: -0.31, spark: [] },
      { symbol: "GBPUSD=X", name: "GBP / USD", value: 1.3422, change: -0.31, spark: [] },
      { symbol: "JPY=X", name: "USD / JPY", value: 160.33, change: 0.45, spark: [] },
      { symbol: "AUDUSD=X", name: "AUD / USD", value: 0.7014, change: -0.19, spark: [] },
    ],
    commodities: [
      { symbol: "CL=F", name: "WTI Crude", value: 85.38, change: 2.14, spark: [] },
      { symbol: "BZ=F", name: "Brent Crude", value: 90.22, change: 2.76, spark: [] },
      { symbol: "NG=F", name: "Natural Gas", value: 2.752, change: -0.22, spark: [] },
      { symbol: "ZC=F", name: "Corn", value: 466, change: -0.53, spark: [] },
      { symbol: "ZW=F", name: "Wheat", value: 654, change: -1.43, spark: [] },
    ],
    metals: [
      { symbol: "GC=F", name: "Gold", value: 4099.4, change: -1.47, spark: [] },
      { symbol: "SI=F", name: "Silver", value: 57.96, change: -1.79, spark: [] },
      { symbol: "HG=F", name: "Copper", value: 6.4775, change: 0.05, spark: [] },
      { symbol: "PL=F", name: "Platinum", value: 1649.1, change: -0.67, spark: [] },
      { symbol: "PA=F", name: "Palladium", value: 1291, change: -1.31, spark: [] },
    ],
    other: [
      { symbol: "^TNX", name: "U.S. 10Y", value: 4.7, change: 0.79, spark: [] },
      { symbol: "TLT", name: "Long Treasuries", value: 82.8, change: -0.06, spark: [] },
      { symbol: "HYG", name: "High Yield", value: 79.47, change: 0.29, spark: [] },
      { symbol: "SOXX", name: "Semiconductors", value: 504.53, change: 8.5, spark: [] },
      { symbol: "KRE", name: "Regional Banks", value: 75.9, change: -0.37, spark: [] },
      { symbol: "BTC", name: "Bitcoin", value: 63696, change: -1.78, spark: [] },
      { symbol: "ETH", name: "Ethereum", value: 1880.98, change: -2.23, spark: [] },
      { symbol: "SOL", name: "Solana", value: 73.56, change: -1.06, spark: [] },
    ],
  };
