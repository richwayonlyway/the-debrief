(function () {
  ...
  const fallbackQuotes = {
    indices: [
      { symbol: "^GSPC", name: "S&P 500", value: 7748.03, change: 0.49, spark: [] },
      { symbol: "^IXIC", name: "Nasdaq", value: 26621.266, change: 1.04, spark: [] },
      { symbol: "^DJI", name: "Dow", value: 54005.19, change: 0.22, spark: [] },
      { symbol: "^RUT", name: "Russell 2000", value: 3025.994, change: 0.81, spark: [] },
      { symbol: "^VIX", name: "VIX", value: 14.97, change: -1.19, spark: [] },
    ],
    currencies: [
      { symbol: "DX-Y.NYB", name: "U.S. Dollar", value: 99.606, change: -0.32, spark: [] },
      { symbol: "EURUSD=X", name: "EUR / USD", value: 1.1554, change: 0.25, spark: [] },
      { symbol: "GBPUSD=X", name: "GBP / USD", value: 1.3487, change: 0.3, spark: [] },
      { symbol: "JPY=X", name: "USD / JPY", value: 157.884, change: -0.36, spark: [] },
      { symbol: "AUDUSD=X", name: "AUD / USD", value: 0.7065, change: 0.48, spark: [] },
    ],
    commodities: [
      { symbol: "CL=F", name: "WTI Crude", value: 77.59, change: 0.39, spark: [] },
      { symbol: "BZ=F", name: "Brent Crude", value: 82.55, change: 0.07, spark: [] },
      { symbol: "NG=F", name: "Natural Gas", value: 2.684, change: 1.67, spark: [] },
      { symbol: "ZC=F", name: "Corn", value: 464, change: 0.43, spark: [] },
      { symbol: "ZW=F", name: "Wheat", value: 640.75, change: 1.5, spark: [] },
    ],
    metals: [
      { symbol: "GC=F", name: "Gold", value: 4403.7, change: 2.42, spark: [] },
      { symbol: "SI=F", name: "Silver", value: 63.895, change: 3.72, spark: [] },
      { symbol: "HG=F", name: "Copper", value: 6.607, change: -1.52, spark: [] },
      { symbol: "PL=F", name: "Platinum", value: 1760.1, change: 1.28, spark: [] },
      { symbol: "PA=F", name: "Palladium", value: 1383.5, change: 0.44, spark: [] },
    ],
    other: [
      { symbol: "^TNX", name: "U.S. 10Y", value: 4.641, change: -0.62, spark: [] },
      { symbol: "TLT", name: "Long Treasuries", value: 82.6, change: 0.1, spark: [] },
      { symbol: "HYG", name: "High Yield", value: 79.575, change: 0.14, spark: [] },
      { symbol: "SOXX", name: "Semiconductors", value: 535.805, change: 0.62, spark: [] },
      { symbol: "KRE", name: "Regional Banks", value: 76.315, change: -0.23, spark: [] },
      { symbol: "BTC", name: "Bitcoin", value: 65086, change: 0.55, spark: [] },
      { symbol: "ETH", name: "Ethereum", value: 1918.93, change: 0.4, spark: [] },
      { symbol: "SOL", name: "Solana", value: 73.95, change: 0.74, spark: [] },
    ],
  };
