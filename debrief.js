(function () {
  ...
  const fallbackQuotes = {
    indices: [
      ...
      { symbol: "^VIX", name: "VIX", value: 15.99, change: -6.44, spark: [] },
    ],
    currencies: [
      { symbol: "DX-Y.NYB", name: "U.S. Dollar", value: 99.803, change: -0.11, spark: [] },
      { symbol: "EURUSD=X", name: "EUR / USD", value: 1.1527, change: -0.02, spark: [] },
      { symbol: "GBPUSD=X", name: "GBP / USD", value: 1.3482, change: 0.13, spark: [] },
      { symbol: "JPY=X", name: "USD / JPY", value: 157.4, change: -1.38, spark: [] },
      { symbol: "AUDUSD=X", name: "AUD / USD", value: 0.7025, change: -0.03, spark: [] },
    ],
    commodities: [
    ...
    metals: [
      { symbol: "GC=F", name: "Gold", value: 4107, change: -1.29, spark: [] },
      { symbol: "SI=F", name: "Silver", value: 57.786, change: -2.09, spark: [] },
      { symbol: "HG=F", name: "Copper", value: 6.4655, change: -0.14, spark: [] },
      { symbol: "PL=F", name: "Platinum", value: 1658.7, change: -0.09, spark: [] },
      { symbol: "PA=F", name: "Palladium", value: 1281.4, change: -2.05, spark: [] },
    ],
    other: [
      { symbol: "^TNX", name: "U.S. 10Y", value: 4.745, change: 1.76, spark: [] },
